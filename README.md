# BERT / LLama (Text Summrization) / Computer Vision / Genrative Pretrained Tranformer Series 

**\*\*\*\*\* New March 14th, 2024:BERT Models \ LLama (Text Summrization) \ Computer Vision \*\*\*\*\***
...
*   If you are pre-training from scratch, be prepared that pre-training is
    ...
    scratch, our recommended recipe is to pre-train a `BERT-Base` on a single which
...
<!---
Techionik-LTD is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
